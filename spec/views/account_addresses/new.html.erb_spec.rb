...
RSpec.describe "account_addresses/new", type: :view do
  before(:each) do
    assign(:account_address, AccountAddress.new(
      :address1 => "MyString",
      :address2 => "MyString",
      :address3 => "MyString",
      :address4 => "MyString",
  ...
  it "renders new account_address form" do
    render

    assert_select "form[action=?][method=?]", account_addresses_path, "post" do
