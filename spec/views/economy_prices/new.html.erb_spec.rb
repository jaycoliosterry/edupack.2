...
RSpec.describe "economy_prices/new", type: :view do
  before(:each) do
    assign(:economy_price, EconomyPrice.new(
      :weight => "9.99",
      :zone1 => "9.99",
      :zone2 => "9.99",
      :zone3 => "9.99",
  ...
  it "renders new economy_price form" do
    render

    assert_select "form[action=?][method=?]", economy_prices_path, "post" do
