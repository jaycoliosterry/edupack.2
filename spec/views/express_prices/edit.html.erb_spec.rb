...
RSpec.describe "express_prices/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit express_price form" do
    render

    assert_select "form[action=?][method=?]", express_price_path(@express_price), "post" do
